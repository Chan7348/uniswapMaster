...
先算出我们提供的流动性：
$$\left(x_{real}+\frac{L}{\sqrt{3001}}\right)L\sqrt{3000}=L^{2}$$
$$L=\frac{\sqrt{3000}\sqrt{3001}X_{real}}{\left(\sqrt{3001}-\sqrt{3000}\right)}$$
根据流动性再算出拿到的USDC数量：
$$\frac{L}{\sqrt{3001}}\left(y_{real}+L\sqrt{3000}\right)=L^{2}$$
$$y_{real}=\left(\sqrt{3001}-\sqrt{3000}\right)L$$
所以最终我们卖出的价格为：
